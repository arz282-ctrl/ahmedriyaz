    ...
    <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card-bg)] p-6 md:p-9">
      ...
      {/* Deliberately not AnimatePresence with mode="wait": that holds the
        ...
        >
          ...
          {step === 0 && (
            <fieldset>
              <legend className="font-display text-2xl font-bold leading-tight tracking-[-0.02em] text-[var(--silver)]">
          ...
          {step === 1 && (
            <div className="space-y-8">
              ...
              <fieldset>
                <legend className="font-display text-2xl font-bold leading-tight tracking-[-0.02em] text-[var(--silver)]">And the timeline?</legend>
          ...
          {step === 2 && (
            <div>
              <label htmlFor="brief" className="font-display text-2xl font-bold leading-tight tracking-[-0.02em] text-[var(--silver)]">
          ...
          {step === 3 && (
            <div>
              <h2 className="font-display text-2xl font-bold leading-tight tracking-[-0.02em] text-[var(--silver)]">How should I reply?</h2>
              <p className="mt-2 font-sans text-sm text-[rgba(224,224,224,0.5)]">
