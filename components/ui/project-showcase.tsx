...
export function ProjectShowcase() {
  ...
  return (
    <section ref={containerRef} onMouseMove={handleMouseMove} className="relative w-full max-w-2xl mx-auto px-6 py-16">
      <h2 className="text-[rgba(224,224,224,0.5)] text-sm font-medium tracking-wide uppercase mb-8">Selected Work</h2>
      ...
      >
        <div className="relative w-[280px] h-[180px] bg-[rgba(255,255,255,0.03)] rounded-xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[rgba(3,6,8,0.2)] to-transparent" />
        </div>
      </div>
      ...
      <div className="space-y-0">
        {projects.map((project, index) => (
          ...
          >
            <div className="relative py-5 border-t border-[rgba(255,255,255,0.08)] transition-all duration-300 ease-out">
              <div
                className={`
                  absolute inset-0 -mx-4 px-4 bg-[rgba(255,255,255,0.03)] rounded-lg
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="inline-flex items-center gap-2">
                    <h3 className="text-[var(--silver)] font-medium text-lg tracking-tight">
                      <span className="relative">
                        {project.title}
                        <span
                          className={`
                            absolute left-0 -bottom-0.5 h-px bg-[var(--silver)]
                            transition-all duration-300 ease-out
                    ...
                    <ArrowUpRight
                      className={`
                        w-4 h-4 text-[rgba(224,224,224,0.5)]
                        transition-all duration-300 ease-out
                        ${
                          hoveredIndex === index
                  ...
                  <p
                    className={`
                      ...
                      transition-all duration-300 ease-out
                      ${hoveredIndex === index ? "text-[rgba(224,224,224,0.7)]" : "text-[rgba(224,224,224,0.5)]"}
                    `}
                  >
                    {project.description}
                  </p>
                ...
                <span
                  className={`
                    ...
                    transition-all duration-300 ease-out
                    ${hoveredIndex === index ? "text-[rgba(224,224,224,0.6)]" : "text-[rgba(224,224,224,0.4)]"}
                  `}
                >
                  {project.year}
                </span>
